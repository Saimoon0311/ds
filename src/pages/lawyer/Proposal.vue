      ...
      <Form @submit="nextStep" :validation-schema="currentSchema" keep-values id="mainForm"
        ...
        <template v-if="currentStep === 1">
                ...
                <label class="w-100 text-start">
                  ...
                  <div>
                    <!-- <span class="position-absolute d-span">
                      ($AUD) 0.00</span> -->
                    <input id="feeEarnerHourlyRate" placeholder="($AUD) 0.00"  min="1" autocomplete="on" type="number" class="form-control "
                      required />
                  </div>
                </label>
                <br />
              ...
              <table class="table table-bordered mb-0" id="additionalFeeEarnersTable">
                ...
                <tbody id="addFeeEarnersRow">
                  <tr>
                    ...
                    <td></td>
                    <td>
                      <p class="mb-0 bg-secondary border p-1 rounded text-white text-center">Total: ($AUD) 0.00</p>
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div class="form-group" id="fixed-fee" v-if="selectedOption === 'Fixed'">
            ...
            <div>
              <!-- <span class="position-absolute d-span"> ($AUD) 0.00</span> -->
              <input type="number" id="fixedFeeAmount" name="fixedFeeAmount" placeholder="($AUD) 0.00"  class="form-control" min="1"
                step=".01" />
            </div>
            <br />
            ...
            <div class="my-3">
              ...
              <div class="my-3" id="upfrontPayAmount" v-if="payment === 'Yes'">
                ...
                <div>
                  <!-- <span class="position-absolute d-span">($AUD) 0.00</span> -->
                  <input id="upfrontAmount" name="upfrontAmount" type="number" placeholder="($AUD) 0.00" min="1" step=".01"
                    class="form-control" />
                </div>
              </div>
            </div>
            ...
            <div v-if="isVisible === 'Yes'">
              ...
              <div id="hourlyRateIndividual">
                ...
                <div>
                  <!-- <span class="position-absolute d-span">
                    ($AUD) 0.00</span> -->
                  <input type="number" placeholder="($AUD) 0.00"  id="hourlyRate" name="hourlyRate" min="1" step="0.01" class="form-control"
              ...
              <p id="finalHourlyRateText">
                Total: ($AUD) 0.00<input id="finalHourlyRateValue" name="finalHourlyRateValue" type="number" readonly=""
          ...
          <div class="form-group" id="success-fee" v-if="selectedOption === 'Success'">
            ...
            <div class="my-3">
              ...
              <div class="my-3" id="upfrontPayAmount" v-if="paySucc === 'Yes'">
                <label>How much upfront payment do you require?<sup><code>*</code></sup></label>
                <div>
                  <!-- <span class="position-absolute d-span" style="line-height: 36px">($AUD) 0.00</span> -->
                  <input id="upfrontAmount" placeholder="($AUD) 0.00" name="upfrontAmount" type="number" min="1" step=".01"
                    class="form-control " />
                </div>
              </div>
            </div>
                ...
                <label class="w-100 text-start">
                  ...
                  <div>
                    <!-- <span class="position-absolute d-span" style="line-height: 36px">
                      ($AUD) 0.00</span> -->
                    <input id="feeEarnerHourlyRate" min="1" autocomplete="on" type="number" class="form-control "
                      required />
                  </div>
                </label>
                <br />
            ...
            <div class="form-group my-3" id="div-freeFirstConsultationFee">
              ...
              <div class="input-group mb-2">
                <div class="input-group-prepend">
                  <div class="input-group-text">($AUD) 0.00</div>
                </div>
